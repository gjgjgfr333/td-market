    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className={'dimensions'}>
            ...
            <div className={'good-dimensions'}>
                ...
                <div className={'description__block'}>
                    <label className={'label'} htmlFor="width">Ширина, см</label>
                    <input
                        id={'width'}
                        className={'modalInput description__input good-dimensions__input'}
                        {...register('width')}
                ...
                <div className={'description__block'}>
                    <label className={'label'} htmlFor="height">Высота, см</label>
                    <input
                        id={'height'}
                        className={'modalInput description__input good-dimensions__input'}
                        {...register('height')}
                ...
                <div className={'description__block'}>
                    <label className={'label'} htmlFor="weight">Вес, кг</label>
                    <input
                        id={'weight'}
                        className={'modalInput description__input good-dimensions__input'}
                        {...register('weight')}
